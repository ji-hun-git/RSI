...
python -m pytest                      # 543 tests (LangGraph conformance and the live OpenAI test skip without extra/key)
...
├── tests/                # 543 tests, including tests/test_e2e_replay.py (capstone)
