...
python -m pytest                      # 519 tests (LangGraph conformance and the live OpenAI test skip without extra/key)
...
├── tests/                # 519 tests, including tests/test_e2e_replay.py (capstone)
