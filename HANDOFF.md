...
- Docs: `README.md`, `docs/ARCHITECTURE.md`, `docs/DECISIONS.md` (ADR-001..011), `docs/ROADMAP.md`, `research/protocols/STAGE1_PROTOCOL.md`, adapter README stubs under `adapters/`.
...
python -m pytest -q                          # expect: 440 passed; LangGraph conformance and the live OpenAI test skip without the extra / OPENAI_API_KEY
