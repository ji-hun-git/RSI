...
python -m pytest                      # 558 tests (LangGraph conformance and the live OpenAI test skip without extra/key)
...
├── tests/                # 558 tests, including tests/test_e2e_replay.py (capstone)
